...
import com.example.networkcalculator.managers.DialogManager;
import com.example.networkcalculator.Utils;
import com.example.networkcalculator.views.LineSwitchView;
import com.example.networkcalculator.views.LineView;
...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        settingInformationGithub.setOnClickListener(view -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/vietkieubui/NetworkCalculator"))));
